...
- [ ] **Stap 3: Implementeer in `app/parser.py`**
...
- [ ] **Stap 4: Draai alle parser-tests**
...
- [ ] **Stap 3: Implementeer in `app/game.py`**
...
- [ ] **Stap 3: Implementeer in `app/editor.py`**
...
- [ ] **Stap 3: Implementeer in `app/ai.py`**
...
- [ ] **Stap 3: Implementeer in `app/weergave.py`**
...
- [ ] **Stap 4: Draai de weergave-tests**
...
- [ ] **Stap 1: Voeg de bom-sprite toe aan `app/templates/fragments/sprites.html`**
...
- [ ] **Stap 2: Zet dezelfde symbol in `docs/superpowers/specs/sprites.svg`**

Op dezelfde plek (vóór `<!-- KOGEL -->`), exact dezelfde regels als in stap 1.

- [ ] **Stap 3: Toon de mijn in `app/templates/fragments/veld.html`**
...
- [ ] **Stap 4: Teller in `app/templates/fragments/status.html`**
...
- [ ] **Stap 6: Bekijk het in de browser**
...
- [ ] **Stap 1: Hoofdontwerp – spelregels**
...
- [ ] **Stap 2: Vink de taken in dit plan af en commit het plan**
